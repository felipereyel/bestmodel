...
Live: https://terryds.github.io/bestvaluemodel/
...
| `.github/workflows/update-and-deploy.yml` | Daily cron + manual trigger + push to `main`. Fetch, commit if changed, deploy Pages. |
